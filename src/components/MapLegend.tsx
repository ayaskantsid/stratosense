...
function MapLegend({ mapType }: Props) {
  ...
  return (
    <div className="absolute top-4 right-4 z-1000 w-48 xs:w-92 rounded-xl shadow-lg p-4 bg-background/50 border border-accent/70 flex flex-col gap-4">
