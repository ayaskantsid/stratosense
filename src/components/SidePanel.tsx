...
export default function SidePanel(props: Props) {
  ...
  return (
    <div
      className={clsx(
        "fixed top-0 right-0 h-screen w-(--sidebar-width) shadow-md bg-sidebar z-1001 py-4 px-4 overflow-y-scroll transition-transform duration-300 lg:translate-x-0!",
